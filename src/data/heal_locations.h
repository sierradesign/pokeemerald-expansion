static const struct HealLocation sHealLocations[] =
{
    ...
    [HEAL_LOCATION_RIDGE_CREST - 1] = {MAP_GROUP(RIDGE_CREST), MAP_NUM(RIDGE_CREST), 9, 15},
    [HEAL_LOCATION_GLADE_VILLAGE - 1] = {MAP_GROUP(GLADE_VILLAGE), MAP_NUM(GLADE_VILLAGE), 11, 13},
};
